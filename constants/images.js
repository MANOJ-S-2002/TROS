...
const burger_restaurant_1 = require("../assets/images/saravana.jpg");
...
const hot_dog_restaurant = require("../assets/images/peter.jpg");
const ice_kacang = require("../assets/images/ice-kacang.jpg");
const japanese_restaurant = require("../assets/images/hm.jpg");
const kek_lapis_shop = require("../assets/images/allen.jpg");
...
const noodle_shop = require("../assets/images/van.jpg");
const pizza_restaurant = require("../assets/images/pothys.jpg");
